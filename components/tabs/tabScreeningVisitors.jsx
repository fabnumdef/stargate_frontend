                                        ...
                                        case 'birthLastname':
                                            return row.vAttachedFile ? (
                                                <TableCell
                                                    ...
                                                    align={column.align}
                                                    className={
                                                        row.screening.step !== ACTIVE_STEP_STATUS
                                                ...
                                                <TableCell
                                                    ...
                                                    <div className={classes.noFile}>{value}</div>
                                                </TableCell>
                                            );
                                        case 'nationality':
                                    ...
                                    <StyledFormLabel
                                        ...
                                        control={
                                            <Radio
                                                ...
                                                checked={
                                                    row.report ===
                                                    ROLES[activeRole.role].workflow.positive
                                                }
                                                onChange={(event) => {
                                                    const newArray = visitors.slice();
                                                    newArray[newArray.indexOf(row)].report =
                                                        event.target.value;
                                                    onChange(newArray);
                                                    deselectAllCheckbox();
                                                }}
                                    ...
                                    <StyledFormLabel
                                        ...
                                        control={
                                            <Radio
                                                ...
                                                checked={
                                                    row.report ===
                                                    ROLES[activeRole.role].workflow.negative
                                                }
                                                onChange={(event) => {
                                                    const newArray = visitors.slice();
                                                    newArray[newArray.indexOf(row)].report =
