...
function createData({ numDemande, dateDemande, periode, motif }) {
    return {
        nDemande: numDemande,
        dateDem: dateDemande,
        demandeur: (demandeur) =>
            (<div>
                <span>
                    ${demandeur.gradeDemandeur} ${demandeur.nomDemandeur} $
...
export default function TabMesDemandes({ tabData }) {
    ...
    const [rows, setRows] = useState(
        tabData.demandes.reduce((acc, dem) => {
